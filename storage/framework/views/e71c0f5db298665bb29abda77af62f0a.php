        ...
        <aside class="w-64 bg-white dark:bg-slate-800 border-r border-gray-200 dark:border-slate-700 flex-shrink-0">
            <div class="flex flex-col h-full p-4">
                ...
                <nav class="flex flex-col gap-1 flex-1">
                    <a class="nav-link active flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-700 dark:text-slate-300 hover:text-gray-900 dark:hover:text-white font-medium text-sm" href="<?php echo e(url('/dashboard')); ?>">
                        <span class="material-symbols-outlined text-xl">dashboard</span>
                        <span>Dashboard</span>
                    </a>
                    <a class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-600 dark:text-slate-400 hover:text-gray-900 dark:hover:text-white font-medium text-sm" href="<?php echo e(url('/subscribers')); ?>">
                        <span class="material-symbols-outlined text-xl">group</span>
                        <span>Subscribers</span>
                    </a>
                    <a class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-600 dark:text-slate-400 hover:text-gray-900 dark:hover:text-white font-medium text-sm" href="<?php echo e(url('/lists')); ?>">
                        <span class="material-symbols-outlined text-xl">list_alt</span>
                        <span>Lists</span>
                    </a>
                    <a class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-600 dark:text-slate-400 hover:text-gray-900 dark:hover:text-white font-medium text-sm" href="<?php echo e(url('/campaigns')); ?>">
                        <span class="material-symbols-outlined text-xl">campaign</span>
                        <span>Campaigns</span>
                    </a>
                    <a class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-600 dark:text-slate-400 hover:text-gray-900 dark:hover:text-white font-medium text-sm" href="<?php echo e(url('/messages')); ?>">
                        <span class="material-symbols-outlined text-xl">chat</span>
                        <span>Messages</span>
                    </a>
                    <a class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-600 dark:text-slate-400 hover:text-gray-900 dark:hover:text-white font-medium text-sm" href="<?php echo e(url('/smtp')); ?>">
                        <span class="material-symbols-outlined text-xl">dns</span>
                        <span>SMTP Settings</span>
                    </a>
                    <a class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-600 dark:text-slate-400 hover:text-gray-900 dark:hover:text-white font-medium text-sm" href="<?php echo e(url('/billing')); ?>">
                        <span class="material-symbols-outlined text-xl">receipt_long</span>
                        <span>Billing</span>
                    </a>
                    <a class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-600 dark:text-slate-400 hover:text-gray-900 dark:hover:text-white font-medium text-sm" href="<?php echo e(url('/profile')); ?>">
        ...
        <main class="flex-1 overflow-y-auto bg-gray-50 dark:bg-slate-900">
                ...
                <div class="px-6 py-4">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center gap-3">
                            <button onclick="window.location.href='<?php echo e(url('/campaigns/create')); ?>'" class="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-2 rounded-lg font-semibold text-sm hover-glow transition-all duration-300">
                                New Campaign
                            </button>
                            <button onclick="window.location.href='<?php echo e(url('/subscribers/create')); ?>'" class="border border-gray-300 dark:border-slate-700 text-gray-700 dark:text-slate-300 px-6 py-2 rounded-lg font-semibold text-sm hover:bg-gray-50 dark:hover:bg-slate-800 transition-all duration-300">
                                Add Subscriber
                            </button>
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="glass-card rounded-2xl p-8 shadow-lg border-2 border-blue-100 dark:border-slate-700 hover-glow transition-all duration-300">
                    <div class="flex items-center justify-between">
                        <div>
                            <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-2">Welcome back, <?php echo e(Auth::user()->name); ?>!</h1>
                            <p class="text-gray-600 dark:text-slate-300 mb-4">Your email marketing dashboard with real-time analytics. Member since <?php echo e(Auth::user()->created_at->format('M Y')); ?></p>
                            <div class="flex items-center gap-6">
                                <div class="flex items-center gap-2">
                                    <span class="material-symbols-outlined <?php echo e(Auth::user()->email_verified_at ? 'text-green-500' : 'text-yellow-500'); ?> text-xl">
                                        <?php echo e(Auth::user()->email_verified_at ? 'verified' : 'warning'); ?>

                                    </span>
                                    <span class="text-gray-600 dark:text-slate-300 text-sm font-medium">
                                        <?php echo e(Auth::user()->email_verified_at ? 'Email Verified' : 'Email Not Verified'); ?>
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-gray-600 dark:text-slate-300 text-sm font-medium">
                                        Last login: <?php echo e(Auth::user()->last_login_at ? Auth::user()->last_login_at->diffForHumans() : 'First time'); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="glass-card rounded-2xl p-6 shadow-lg hover-glow transition-all duration-300">
                        ...
                        <p id="totalSubscribers" class="text-4xl font-bold text-gray-900 dark:text-white mb-2"><?php echo e(number_format($totalSubscribers ?? 0)); ?></p>
                        <p class="text-green-600 dark:text-green-400 text-sm font-medium"><?php echo e(($subscriberGrowth ?? 0) >= 0 ? '+' : ''); ?><?php echo e($subscriberGrowth ?? 0); ?>% growth</p>
                    </div>
                    ...
                    <div class="glass-card rounded-2xl p-6 shadow-lg hover-glow transition-all duration-300">
                        ...
                        <p class="text-4xl font-bold text-gray-900 dark:text-white mb-2"><?php echo e($campaignsTotal ?? 0); ?></p>
                        <p class="text-green-600 dark:text-green-400 text-sm font-medium"><?php echo e(($campaignGrowth ?? 0) >= 0 ? '+' : ''); ?><?php echo e($campaignGrowth ?? 0); ?>% growth</p>
                    </div>
                    ...
                    <div class="glass-card rounded-2xl p-6 shadow-lg hover-glow transition-all duration-300">
                        ...
                        <p id="totalEmailsSent" class="text-4xl font-bold text-gray-900 dark:text-white mb-2"><?php echo e(number_format($totalEmailsSent ?? 0)); ?></p>
                        <p class="text-green-600 dark:text-green-400 text-sm font-medium"><?php echo e($emailsToday ?? 0); ?> today</p>
                    </div>
                    ...
                    <div class="glass-card rounded-2xl p-6 shadow-lg hover-glow transition-all duration-300">
                        ...
                        <p class="text-4xl font-bold text-gray-900 dark:text-white mb-2"><?php echo e($openRate ?? 0); ?>%</p>
                        <p class="text-green-600 dark:text-green-400 text-sm font-medium"><?php echo e(($openGrowth ?? 0) >= 0 ? '+' : ''); ?><?php echo e($openGrowth ?? 0); ?>% trend</p>
                    </div>
                    ...
                    <div class="glass-card rounded-2xl p-6 shadow-lg hover-glow transition-all duration-300">
                        ...
                        <p class="text-4xl font-bold text-gray-900 dark:text-white mb-2"><?php echo e($clickRate ?? 0); ?>%</p>
                        <p class="text-green-600 dark:text-green-400 text-sm font-medium"><?php echo e(number_format($totalClicks ?? 0)); ?> total</p>
                    </div>
                    ...
                    <div class="glass-card rounded-2xl p-6 shadow-lg hover-glow transition-all duration-300">
                        ...
                        <p class="text-4xl font-bold text-gray-900 dark:text-white mb-2"><?php echo e($engagementRate ?? 0); ?>%</p>
                        <p class="text-green-600 dark:text-green-400 text-sm font-medium"><?php echo e(($engagementGrowth ?? 0) >= 0 ? '+' : ''); ?><?php echo e($engagementGrowth ?? 0); ?>% growth</p>
                    </div>
                </div>
                            ...
                            <div class="space-y-4">
                                <div class="flex items-center justify-between p-3 bg-blue-50 dark:bg-blue-900/20 rounded-xl">
                                    <div>
                                        ...
                                        <p id="emailsToday" class="text-gray-900 dark:text-white text-2xl font-bold"><?php echo e($emailsToday ?? 0); ?></p>
                                    </div>
                                    <div class="p-2 bg-blue-100 dark:bg-blue-900/50 rounded-lg">
                                ...
                                <div class="flex items-center justify-between p-3 bg-green-50 dark:bg-green-900/20 rounded-xl">
                                    <div>
                                        ...
                                        <p id="opensToday" class="text-gray-900 dark:text-white text-2xl font-bold"><?php echo e($opensToday ?? 0); ?></p>
                                    </div>
                                    <div class="p-2 bg-green-100 dark:bg-green-900/50 rounded-lg">
                                ...
                                <div class="flex items-center justify-between p-3 bg-purple-50 dark:bg-purple-900/20 rounded-xl">
                                    <div>
                                        ...
                                        <p id="clicksToday" class="text-gray-900 dark:text-white text-2xl font-bold"><?php echo e($clicksToday ?? 0); ?></p>
                                    </div>
                                    <div class="p-2 bg-purple-100 dark:bg-purple-900/50 rounded-lg">
                                ...
                                <div class="flex items-center justify-between p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-xl">
                                    <div>
                                        ...
                                        <p id="activeCampaigns" class="text-gray-900 dark:text-white text-2xl font-bold"><?php echo e($activeCampaigns ?? 0); ?></p>
                                    </div>
                                    <div class="p-2 bg-yellow-100 dark:bg-yellow-900/50 rounded-lg">
                    ...
                    <div class="lg:col-span-2">
                        <div class="glass-card rounded-2xl p-6 shadow-lg">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <a href="<?php echo e(url('/campaigns/create')); ?>" class="group p-6 bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-xl hover:shadow-lg transition-all duration-300 hover-glow">
                                ...
                                <a href="<?php echo e(url('/subscribers/import')); ?>" class="group p-6 bg-gradient-to-br from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20 rounded-xl hover:shadow-lg transition-all duration-300 hover-glow">
                                ...
                                <a href="<?php echo e(url('/smtp')); ?>" class="group p-6 bg-gradient-to-br from-yellow-50 to-orange-50 dark:from-yellow-900/20 dark:to-orange-900/20 rounded-xl hover:shadow-lg transition-all duration-300 hover-glow">
...
</html><?php /**PATH /mnt/c/Users/DELL/InfiMal/InfiMal-main/resources/views/dashboard.blade.php ENDPATH**/ ?>