                ...
                <div class="px-6 py-4">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <a href="<?php echo e(url('/campaigns')); ?>" class="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-2 rounded-lg font-semibold text-sm hover-glow">
                            ...
                            <div class="space-y-6">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="fromName" class="w-full border border-gray-300 dark:border-slate-700 rounded-lg px-4 py-3 bg-white dark:bg-slate-800 focus:ring-2 focus:ring-blue-500" value="<?php echo e($user->name ?? 'Your Name'); ?>" required onkeyup="updateProgress()">
                                    </div>
                                    <div>
                                        <label class="block text-gray-700 dark:text-slate-300 text-sm font-medium mb-2">From Email *</label>
                                        <input type="email" id="fromEmail" class="w-full border border-gray-300 dark:border-slate-700 rounded-lg px-4 py-3 bg-white dark:bg-slate-800 focus:ring-2 focus:ring-blue-500" value="<?php echo e($user->email ?? 'your@email.com'); ?>" required onkeyup="updateProgress()">
                                    </div>
                                    <div>
                                        <label class="block text-gray-700 dark:text-slate-300 text-sm font-medium mb-2">Reply To Email</label>
                                        <input type="email" id="replyTo" class="w-full border border-gray-300 dark:border-slate-700 rounded-lg px-4 py-3 bg-white dark:bg-slate-800 focus:ring-2 focus:ring-blue-500" value="<?php echo e($user->email ?? 'support@yourdomain.com'); ?>">
                                    </div>
                                    <div>
                                        ...
                                        <select id="listSelect" class="w-full border border-gray-300 dark:border-slate-700 rounded-lg px-4 py-3 bg-white dark:bg-slate-800 focus:ring-2 focus:ring-blue-500" required onchange="updateProgress()">
                                            ...
                                            ?>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $mailingLists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <option value="<?php echo e($list->id); ?>"><?php echo e($list->name); ?> (<?php echo e(number_format($list->subscriber_count ?? 0)); ?> contacts)</option>
...
Best regards,  
<?php echo e($user->name ?? 'Your Team'); ?>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="glass-card rounded-2xl p-6 shadow-lg">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <span class="text-gray-900 dark:text-white font-semibold"><?php echo e(number_format($campaignsTotal)); ?></span>
                                </div>
                                <div class="flex items-center justify-between">
                                    <span class="text-gray-600 dark:text-slate-400">Active Campaigns</span>
                                    <span class="text-gray-900 dark:text-white font-semibold"><?php echo e(number_format($campaignsActive)); ?></span>
                                </div>
                                <div class="flex items-center justify-between">
                                    <span class="text-gray-600 dark:text-slate-400">Total Sent</span>
                                    <span class="text-gray-900 dark:text-white font-semibold"><?php echo e(number_format($campaignsSent)); ?></span>
                                </div>
                                <div class="flex items-center justify-between">
                                    <span class="text-gray-600 dark:text-slate-400">Avg Open Rate</span>
                                    <span class="text-green-600 dark:text-green-400 font-semibold"><?php echo e($campaignsOpenRate); ?>%</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="glass-card rounded-2xl p-6 shadow-lg">
                            ...
                            <div class="space-y-3">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $recentCampaignsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $campaign): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <?php
                                    ...
                                    <div class="flex items-center justify-between p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-slate-800/30">
                                        <div>
                                            <p class="text-gray-900 dark:text-white text-sm font-medium"><?php echo e($campaign->name ?? 'Untitled'); ?></p>
                                            <p class="text-gray-500 dark:text-slate-500 text-xs"><?php echo e(isset($campaign->updated_at) ? \Carbon\Carbon::parse($campaign->updated_at)->diffForHumans() : 'Recently'); ?></p>
                                        </div>
                                        <span class="bg-<?php echo e($statusColorClass); ?>-100 dark:bg-<?php echo e($statusColorClass); ?>-900/50 text-<?php echo e($statusColorClass); ?>-600 dark:text-<?php echo e($statusColorClass); ?>-400 text-xs px-2 py-1 rounded">
                                            <?php echo e($statusTextDisplay); ?>
...
The Team`
        ...
        // Test Email
        function testEmail() {
            const email = prompt('Enter test email:', '<?php echo e($user->email ?? "test@example.com"); ?>');
            if(email) {
                showLoading(true);
                setTimeout(() => {
                    showLoading(false);
...
</html><?php /**PATH /mnt/c/Users/DELL/InfiMal/InfiMal-main/resources/views/campaigns/create.blade.php ENDPATH**/ ?>