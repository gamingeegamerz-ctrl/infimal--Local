    ...
    <div class="w-full max-w-md">
        <div class="bg-white rounded-2xl shadow-2xl p-8">
            <div class="text-center mb-8">
                ...
                <p class="text-gray-600">Sign up for your InfiMal account</p>
            </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="text-center mt-6">
                <p class="text-gray-600">
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="text-blue-600 font-semibold hover:text-blue-700">Sign in</a>
                </p>
            </div>
        </div>
    </div>
...
<?php /**PATH /mnt/c/Users/DELL/InfiMal/InfiMal-main/resources/views/auth/register.blade.php ENDPATH**/ ?>