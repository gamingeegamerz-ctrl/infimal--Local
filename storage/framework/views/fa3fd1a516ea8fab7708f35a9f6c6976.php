...
<body class="bg-white dark:bg-slate-900 text-gray-900 dark:text-slate-100 transition-colors duration-300">
        ...
        <aside class="w-64 bg-white dark:bg-slate-800 border-r border-gray-200 dark:border-slate-700 flex-shrink-0">
            <div class="flex flex-col h-full p-4">
                ...
                <nav class="flex flex-col gap-1 flex-1">
                    <a class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-600 dark:text-slate-300 hover:text-gray-900 dark:hover:text-white font-medium text-sm" href="<?php echo e(url('/dashboard')); ?>">
                        <span class="material-symbols-outlined text-xl">dashboard</span>
                        <span>Dashboard</span>
                    </a>
                    <a class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-600 dark:text-slate-300 hover:text-gray-900 dark:hover:text-white font-medium text-sm" href="<?php echo e(url('/subscribers')); ?>">
                        <span class="material-symbols-outlined text-xl">group</span>
                        <span>Subscribers</span>
                    </a>
                    <a class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-600 dark:text-slate-300 hover:text-gray-900 dark:hover:text-white font-medium text-sm" href="<?php echo e(url('/lists')); ?>">
                        <span class="material-symbols-outlined text-xl">list_alt</span>
                        <span>Lists</span>
                    </a>
                    <a class="nav-link active flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-700 dark:text-white font-medium text-sm" href="<?php echo e(url('/campaigns')); ?>">
                        <span class="material-symbols-outlined text-xl">campaign</span>
                        <span>Campaigns</span>
                    </a>
                    <a class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-600 dark:text-slate-300 hover:text-gray-900 dark:hover:text-white font-medium text-sm" href="<?php echo e(url('/messages')); ?>">
                        <span class="material-symbols-outlined text-xl">chat</span>
                        <span>Messages</span>
                    </a>
                    <a class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-600 dark:text-slate-300 hover:text-gray-900 dark:hover:text-white font-medium text-sm" href="<?php echo e(url('/smtp')); ?>">
                        <span class="material-symbols-outlined text-xl">dns</span>
                        <span>SMTP Settings</span>
                    </a>
                    <a class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-600 dark:text-slate-300 hover:text-gray-900 dark:hover:text-white font-medium text-sm" href="<?php echo e(url('/billing')); ?>">
                        <span class="material-symbols-outlined text-xl">receipt_long</span>
                        <span>Billing</span>
                    </a>
                    <a class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-600 dark:text-slate-300 hover:text-gray-900 dark:hover:text-white font-medium text-sm" href="<?php echo e(url('/profile')); ?>">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-content">
                                    <a href="<?php echo e(url('/profile')); ?>" class="flex items-center gap-2 px-3 py-2 text-sm text-gray-700 dark:text-slate-300 hover:bg-gray-100 dark:hover:bg-slate-700 rounded">
                                        <span class="material-symbols-outlined text-sm">person</span>
                                        Profile
                                    </a>
                                    <a href="<?php echo e(url('/settings')); ?>" class="flex items-center gap-2 px-3 py-2 text-sm text-gray-700 dark:text-slate-300 hover:bg-gray-100 dark:hover:bg-slate-700 rounded">
            ...
            <div class="p-6 space-y-6">
                            ...
                            <div class="flex flex-wrap items-center gap-4">
                                <div class="flex items-center gap-2 bg-white dark:bg-slate-800 px-3 py-2 rounded-lg">
                                    ...
                                    <span class="text-gray-600 dark:text-slate-300 text-sm font-medium">
                                        Total Campaigns: <span class="font-bold text-gray-900 dark:text-white"><?php echo e($totalCampaigns ?? count($campaigns ?? [])); ?></span>
                                    </span>
                                </div>
                                <div class="flex items-center gap-2 bg-white dark:bg-slate-800 px-3 py-2 rounded-lg">
                                    <span class="material-symbols-outlined text-blue-500 text-xl">send</span>
                                    <span class="text-gray-600 dark:text-slate-300 text-sm font-medium">
                                        Sent: <span class="font-bold text-gray-900 dark:text-white"><?php echo e($sentCount ?? 0); ?></span>
                                    </span>
                                </div>
                                <div class="flex items-center gap-2 bg-white dark:bg-slate-800 px-3 py-2 rounded-lg">
                                    <span class="material-symbols-outlined text-purple-500 text-xl">trending_up</span>
                                    <span class="text-gray-600 dark:text-slate-300 text-sm font-medium">
                                        Avg Open Rate: <span class="font-bold text-gray-900 dark:text-white"><?php echo e($avgOpenRate ?? 0); ?>%</span>
                                    </span>
                                </div>
                                <div class="flex items-center gap-2 bg-white dark:bg-slate-800 px-3 py-2 rounded-lg">
                                    <span class="material-symbols-outlined text-orange-500 text-xl">click</span>
                                    <span class="text-gray-600 dark:text-slate-300 text-sm font-medium">
                                        Avg Click Rate: <span class="font-bold text-gray-900 dark:text-white"><?php echo e($avgClickRate ?? 0); ?>%</span>
                                    </span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div class="glass-card rounded-2xl p-6 shadow-lg hover-glow transition-all duration-300 campaign-card">
                        ...
                        <p class="text-4xl font-bold text-gray-900 dark:text-white mb-2"><?php echo e($totalCampaigns ?? count($campaigns ?? [])); ?></p>
                        <div class="flex items-center justify-between">
                            <p class="text-green-600 dark:text-green-400 text-sm font-medium"><?php echo e($draftCount ?? 0); ?> drafts</p>
                            <div class="flex items-center text-sm">
                                <span class="material-symbols-outlined text-green-500 text-sm mr-1">trending_up</span>
                                <span class="text-green-600 dark:text-green-400">+<?php echo e($growthRate ?? 0); ?>%</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="glass-card rounded-2xl p-6 shadow-lg hover-glow transition-all duration-300 campaign-card">
                        ...
                        <p class="text-4xl font-bold text-gray-900 dark:text-white mb-2"><?php echo e($activeCount ?? 0); ?></p>
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-2">
                                <span class="status-indicator status-scheduled-indicator"></span>
                                <span class="text-gray-600 dark:text-slate-400 text-sm"><?php echo e($scheduledCount ?? 0); ?> scheduled</span>
                            </div>
                            <div class="flex items-center gap-2">
                                <span class="status-indicator status-sending-indicator"></span>
                                <span class="text-gray-600 dark:text-slate-400 text-sm"><?php echo e($sendingCount ?? 0); ?> sending</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="glass-card rounded-2xl p-6 shadow-lg hover-glow transition-all duration-300 campaign-card">
                        ...
                        <p class="text-4xl font-bold text-gray-900 dark:text-white mb-2"><?php echo e($avgOpenRate ?? 0); ?>%</p>
                        <div class="space-y-2">
                            <div class="progress-bar">
                                <div class="progress-bar-fill progress-purple" style="width: <?php echo e(min($avgOpenRate ?? 0, 100)); ?>%"></div>
                            </div>
                            <div class="flex justify-between text-xs text-gray-500 dark:text-slate-400">
                                <span>Industry avg: 20%</span>
                                <span class="<?php echo e(($avgOpenRate ?? 0) >= 20 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'); ?>">
                                    <?php echo e(($avgOpenRate ?? 0) >= 20 ? '+' : ''); ?><?php echo e(number_format(($avgOpenRate ?? 0) - 20, 1)); ?>%
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="glass-card rounded-2xl p-6 shadow-lg hover-glow transition-all duration-300 campaign-card">
                        ...
                        <p class="text-4xl font-bold text-gray-900 dark:text-white mb-2"><?php echo e($avgClickRate ?? 0); ?>%</p>
                        <div class="space-y-2">
                            <div class="progress-bar">
                                <div class="progress-bar-fill progress-orange" style="width: <?php echo e(min($avgClickRate ?? 0, 100)); ?>%"></div>
                            </div>
                            <div class="flex justify-between text-xs text-gray-500 dark:text-slate-400">
                                <span>Industry avg: 3%</span>
                                <span class="<?php echo e(($avgClickRate ?? 0) >= 3 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'); ?>">
                                    <?php echo e(($avgClickRate ?? 0) >= 3 ? '+' : ''); ?><?php echo e(number_format(($avgClickRate ?? 0) - 3, 1)); ?>%
                                </span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="glass-card rounded-2xl p-6 shadow-lg">
                            ...
                            <div class="overflow-x-auto">
                                <table class="w-full min-w-full">
                                    ...
                                    <tbody id="campaignsTableBody">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($campaignsCount > 0): ?>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $campaignsData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $campaign): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="border-b border-gray-100 dark:border-slate-800 last:border-0 hover:bg-gray-50 dark:hover:bg-slate-800/50 transition-colors campaign-card">
                                                <td class="py-4 pl-4">
                                                    <div class="flex items-center gap-3">
                                                        <div class="p-2 rounded-lg bg-blue-100 dark:bg-blue-900/50">
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($campaign->type) && $campaign->type == 'automated'): ?>
                                                            <span class="material-symbols-outlined text-blue-600 dark:text-blue-400 text-sm">schedule</span>
                                                            <?php elseif(isset($campaign->type) && $campaign->type == 'abtest'): ?>
                                                        ...
                                                        <div>
                                                            <p class="text-gray-900 dark:text-white font-medium"><?php echo e($campaign->name ?? 'Untitled Campaign'); ?></p>
                                                            <p class="text-gray-600 dark:text-slate-400 text-sm"><?php echo e($campaign->subject ?? 'No subject'); ?></p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="py-4">
                                                    <div class="flex items-center">
                                                        <span class="status-indicator status-<?php echo e($campaign->status ?? 'draft'); ?>-indicator"></span>
                                                        <span class="campaign-status status-<?php echo e($campaign->status ?? 'draft'); ?>">
                                                            <?php echo e(ucfirst($campaign->status ?? 'draft')); ?>
                                                ...
                                                <td class="py-4">
                                                    <div>
                                                        <span class="text-gray-900 dark:text-white font-medium"><?php echo e(number_format($campaign->total_recipients ?? 0)); ?></span>
                                                        <p class="text-gray-600 dark:text-slate-400 text-xs">
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($campaign->list) && $campaign->list): ?>
                                                                <?php echo e($campaign->list->name ?? 'No list'); ?>
                                                    ...
                                                    <div class="flex items-center gap-4">
                                                        <div>
                                                            <p class="text-gray-900 dark:text-white text-sm font-medium">
                                                                <?php echo e($campaign->opens_count ?? 0); ?>

                                                                <span class="text-green-600 dark:text-green-400 text-xs">
                                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($campaign->total_recipients ?? 0) > 0): ?>
                                                                        (<?php echo e(number_format(($campaign->opens_count ?? 0) / $campaign->total_recipients * 100, 1)); ?>%)
                                                                    <?php else: ?>
                                                                        (0%)
                                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                                </span>
                                                        ...
                                                        <div>
                                                            <p class="text-gray-900 dark:text-white text-sm font-medium">
                                                                <?php echo e($campaign->clicks_count ?? 0); ?>

                                                                <span class="text-green-600 dark:text-green-400 text-xs">
                                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($campaign->total_recipients ?? 0) > 0): ?>
                                                                        (<?php echo e(number_format(($campaign->clicks_count ?? 0) / $campaign->total_recipients * 100, 1)); ?>%)
                                                                    <?php else: ?>
                                                                        (0%)
                                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                                </span>
                                                ...
                                                <td class="py-4">
                                                    <div>
                                                        <p class="text-gray-900 dark:text-white text-sm">
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($campaign->created_at)): ?>
                                                                <?php echo e($campaign->created_at->format('M d, Y')); ?>

                                                            <?php else: ?>
                                                                N/A
                                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                        </p>
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($campaign->status) && $campaign->status == 'scheduled' && isset($campaign->scheduled_at)): ?>
                                                        <p class="text-blue-600 dark:text-blue-400 text-xs">
                                                            <?php echo e(\Carbon\Carbon::parse($campaign->scheduled_at)->format('M d, H:i')); ?>
                                                ...
                                                <td class="py-4 pr-4">
                                                    <div class="flex items-center gap-2">
                                                        <?php if(isset($campaign->status) && $campaign->status == 'draft'): ?>
                                                        <button onclick="previewCampaign(<?php echo e($campaign->id ?? 1); ?>)" class="p-2 rounded-lg bg-gray-100 dark:bg-slate-800 text-gray-600 dark:text-slate-400 hover:bg-gray-200 dark:hover:bg-slate-700 transition-colors" title="Preview">
                                                            <span class="material-symbols-outlined text-sm">visibility</span>
                                                        </button>
                                                        <?php else: ?>
                                                        <a href="<?php echo e(url('/campaigns/' . ($campaign->id ?? 1))); ?>" class="p-2 rounded-lg bg-blue-100 dark:bg-blue-900/50 text-blue-600 dark:text-blue-400 hover:bg-blue-200 dark:hover:bg-blue-800 transition-colors" title="View">
                                                            <span class="material-symbols-outlined text-sm">visibility</span>
                                                        </a>
                                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                        
                                                        <?php if(isset($campaign->status) && in_array($campaign->status, ['draft', 'scheduled'])): ?>
                                                        <button onclick="editCampaign(<?php echo e($campaign->id ?? 1); ?>)" class="p-2 rounded-lg bg-gray-100 dark:bg-slate-800 text-gray-600 dark:text-slate-400 hover:bg-gray-200 dark:hover:bg-slate-700 transition-colors" title="Edit">
                                                            <span class="material-symbols-outlined text-sm">edit</span>
                                                        </button>
                                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                        
                                                        <?php if(isset($campaign->status) && in_array($campaign->status, ['sent', 'sending'])): ?>
                                                        <button onclick="viewAnalytics(<?php echo e($campaign->id ?? 1); ?>)" class="p-2 rounded-lg bg-green-100 dark:bg-green-900/50 text-green-600 dark:text-green-400 hover:bg-green-200 dark:hover:bg-green-800 transition-colors" title="Analytics">
                                                            <span class="material-symbols-outlined text-sm">analytics</span>
                                                        </button>
                                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                        
                                                        <?php if(isset($campaign->status) && $campaign->status == 'scheduled'): ?>
                                                        <button onclick="sendNow(<?php echo e($campaign->id ?? 1); ?>)" class="p-2 rounded-lg bg-blue-100 dark:bg-blue-900/50 text-blue-600 dark:text-blue-400 hover:bg-blue-200 dark:hover:bg-blue-800 transition-colors" title="Send Now">
                                                        ...
                                                        <div class="dropdown relative">
                                                            ...
                                                            <div class="dropdown-content left-auto right-0">
                                                                <button onclick="duplicateCampaign(<?php echo e($campaign->id ?? 1); ?>)" class="flex items-center gap-2 px-3 py-2 text-sm text-gray-700 dark:text-slate-300 hover:bg-gray-100 dark:hover:bg-slate-700 rounded w-full">
                                                                    <span class="material-symbols-outlined text-sm">content_copy</span>
                                                                    Duplicate
                                                                </button>
                                                                <?php if(isset($campaign->status) && $campaign->status == 'draft'): ?>
                                                                <button onclick="scheduleCampaign(<?php echo e($campaign->id ?? 1); ?>)" class="flex items-center gap-2 px-3 py-2 text-sm text-gray-700 dark:text-slate-300 hover:bg-gray-100 dark:hover:bg-slate-700 rounded w-full">
                                                                    <span class="material-symbols-outlined text-sm">schedule</span>
                                                                    Schedule
                                                                </button>
                                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                                <button onclick="deleteCampaign(<?php echo e($campaign->id ?? 1); ?>)" class="flex items-center gap-2 px-3 py-2 text-sm text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 rounded w-full">
                            ...
                            <div class="flex items-center justify-between pt-6 mt-6 border-t border-gray-200 dark:border-slate-700">
                                <div class="text-gray-600 dark:text-slate-400 text-sm">
                                    Showing <?php echo e($showingCampaigns); ?> of <?php echo e($totalCampaignsCount); ?> campaigns
                                </div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($totalCampaignsCount > 10): ?>
                                <div class="flex items-center gap-2">
                    ...
                    <div class="lg:col-span-1 flex flex-col gap-6">
                        ...
                        <div class="glass-card rounded-2xl p-6 shadow-lg">
                            ...
                            <div class="space-y-3">
                                ...
                                <a href="<?php echo e(url('/templates')); ?>" class="w-full flex items-center gap-3 p-3 rounded-lg bg-gray-50 dark:bg-slate-800/50 hover:bg-gray-100 dark:hover:bg-slate-800 transition-colors">
                                ...
                                <a href="<?php echo e(url('/analytics')); ?>" class="w-full flex items-center gap-3 p-3 rounded-lg bg-gray-50 dark:bg-slate-800/50 hover:bg-gray-100 dark:hover:bg-slate-800 transition-colors">
                            ...
                            <div class="space-y-4">
                                <div>
                                    <div class="flex justify-between mb-1">
                                        ...
                                        <span class="text-gray-900 dark:text-white text-sm font-medium"><?php echo e($avgOpenRate ?? 0); ?>%</span>
                                    </div>
                                    <div class="progress-bar">
                                        <div class="progress-bar-fill progress-blue" style="width: <?php echo e(min($avgOpenRate ?? 0, 100)); ?>%"></div>
                                    </div>
                                </div>
                                <div>
                                    <div class="flex justify-between mb-1">
                                        <span class="text-gray-600 dark:text-slate-400 text-sm">Click Rate</span>
                                        <span class="text-gray-900 dark:text-white text-sm font-medium"><?php echo e($avgClickRate ?? 0); ?>%</span>
                                    </div>
                                    <div class="progress-bar">
                                        <div class="progress-bar-fill progress-green" style="width: <?php echo e(min($avgClickRate ?? 0, 100)); ?>%"></div>
                                    </div>
                                </div>
                                <div>
                                    <div class="flex justify-between mb-1">
                                        <span class="text-gray-600 dark:text-slate-400 text-sm">Bounce Rate</span>
                                        <span class="text-gray-900 dark:text-white text-sm font-medium"><?php echo e($bounceRate ?? 0); ?>%</span>
                                    </div>
                                    <div class="progress-bar">
                                        <div class="progress-bar-fill progress-orange" style="width: <?php echo e(min($bounceRate ?? 0, 100)); ?>%"></div>
                                    </div>
                                </div>
                                <div>
                                    <div class="flex justify-between mb-1">
                                        <span class="text-gray-600 dark:text-slate-400 text-sm">Unsubscribe Rate</span>
                                        <span class="text-gray-900 dark:text-white text-sm font-medium"><?php echo e($unsubscribeRate ?? 0); ?>%</span>
                                    </div>
                                    <div class="progress-bar">
                                        <div class="progress-bar-fill progress-purple" style="width: <?php echo e(min($unsubscribeRate ?? 0, 100)); ?>%"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="glass-card rounded-2xl p-6 shadow-lg">
                            ...
                            <div class="space-y-3">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($recentCampaigns) > 0): ?>
                                    ...
                                    <div class="flex items-center justify-between p-2 rounded-lg bg-gray-50 dark:bg-slate-800/50 hover:bg-gray-100 dark:hover:bg-slate-800 transition-colors cursor-pointer" onclick="viewCampaign(<?php echo e($campaign['id'] ?? 1); ?>)">
                                        <div class="flex items-center gap-2">
                                            <span class="material-symbols-outlined text-blue-500 text-sm">campaign</span>
                                            <div>
                                                <span class="text-gray-900 dark:text-white text-sm truncate block max-w-[120px]"><?php echo e(Str::limit($campaign['name'] ?? 'Untitled', 20)); ?></span>
                                                <span class="campaign-status status-<?php echo e($campaign['status'] ?? 'draft'); ?> text-xs mt-1">
                                                    <?php echo e(ucfirst($campaign['status'] ?? 'draft')); ?>
                                        ...
                                        <span class="text-gray-600 dark:text-slate-400 text-xs">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($campaign['status']) && $campaign['status'] == 'sent' && isset($campaign['sent_at'])): ?>
                                                <?php echo e(\Carbon\Carbon::parse($campaign['sent_at'])->format('M d')); ?>

                                            <?php elseif(isset($campaign['status']) && $campaign['status'] == 'scheduled' && isset($campaign['scheduled_at'])): ?>
                                                <?php echo e(\Carbon\Carbon::parse($campaign['scheduled_at'])->format('M d')); ?>

                                            <?php else: ?>
                                                <?php echo e(isset($campaign['created_at']) ? \Carbon\Carbon::parse($campaign['created_at'])->format('M d') : 'N/A'); ?>
    ...
    <div id="createCampaignModal" class="modal-backdrop modal-hidden">
        <div class="bg-white dark:bg-slate-800 rounded-2xl p-6 w-full max-w-2xl shadow-2xl">
            ...
            <form id="campaignForm" action="<?php echo e(route('campaigns.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="list_id" class="w-full border border-gray-300 dark:border-slate-700 rounded-lg px-3 py-2 text-gray-900 dark:text-white bg-white dark:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" required>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($lists) && is_countable($lists) && count($lists) > 0): ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($list->id); ?>"><?php echo e($list->name); ?> (<?php echo e($list->subscribers_count ?? 0); ?> subscribers)</option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php else: ?>
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <select id="scheduleCampaignSelect" class="w-full border border-gray-300 dark:border-slate-700 rounded-lg px-3 py-2 text-gray-900 dark:text-white bg-white dark:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($campaigns) && is_countable($campaigns)): ?>
        ...
        if (searchInput) {
            searchInput.addEventListener('keyup', function(e) {
                if (e.key === 'Enter') {
                    ...
                    if (searchTerm) {
                        window.location.href = "<?php echo e(url('/campaigns')); ?>?search=" + encodeURIComponent(searchTerm);
                    }
                }
            });
        }
...
</html><?php /**PATH /mnt/c/Users/DELL/InfiMal/InfiMal-main/resources/views/campaigns/index.blade.php ENDPATH**/ ?>