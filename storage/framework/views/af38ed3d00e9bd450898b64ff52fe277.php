        ...
        <div class="relative z-10 flex h-full min-h-screen">
            ...
            <nav class="flex-shrink-0 w-64 p-4">
                <div class="flex flex-col h-full gap-4">
                    ...
                    <div class="flex flex-col gap-2 mt-4">
                        <a class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-white/10 text-white/70" href="<?php echo e(url('/dashboard')); ?>">
                            <span class="material-symbols-outlined">dashboard</span>
                            <p class="text-sm font-medium leading-normal">Dashboard</p>
                        </a>
                        <a class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-white/10 text-white/70" href="<?php echo e(url('/subscribers')); ?>">
                            <span class="material-symbols-outlined">group</span>
                            <p class="text-sm font-medium leading-normal">Subscribers</p>
                        </a>
                        <a class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-white/10 text-white/70" href="<?php echo e(url('/lists')); ?>">
                            <span class="material-symbols-outlined">list_alt</span>
                            <p class="text-sm font-medium leading-normal">Lists</p>
                        </a>
                        <a class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-white/10 text-white/70" href="<?php echo e(url('/campaigns')); ?>">
                            <span class="material-symbols-outlined">campaign</span>
                            <p class="text-sm font-medium leading-normal">Campaigns</p>
                        </a>
                        <a class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-white/10 text-white/70" href="<?php echo e(url('/messages')); ?>">
                            <span class="material-symbols-outlined">chat</span>
                            <p class="text-sm font-medium leading-normal">Messages</p>
                        </a>
                        <a class="flex items-center gap-3 px-3 py-2 rounded-lg bg-blue-500/20 text-white" href="<?php echo e(url('/smtp')); ?>">
                            <span class="material-symbols-outlined text-white">dns</span>
                            <p class="text-sm font-medium leading-normal">SMTP Settings</p>
                        </a>
                        <a class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-white/10 text-white/70" href="<?php echo e(url('/billing')); ?>">
                            <span class="material-symbols-outlined">receipt_long</span>
                            <p class="text-sm font-medium leading-normal">Billing</p>
                        </a>
                        <a class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-white/10 text-white/70" href="<?php echo e(url('/profile')); ?>">
            ...
            <main class="flex-1 flex flex-col p-6 overflow-y-auto">
                ...
                <header class="flex-shrink-0 glass-card rounded-xl px-6 py-3 sticky top-6 z-20">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex flex-1 justify-end gap-4 items-center">
                            ...
                            <div class="bg-center bg-no-repeat aspect-square bg-cover rounded-full size-10" style='background-image: url("https://ui-avatars.com/api/?name=<?php echo e(urlencode(Auth::user()->name)); ?>&color=FFFFFF&background=3B82F6");'></div>
                        </div>
                    </div>
                </header>
                    ...
                    <div class="glass-card rounded-xl p-6 soft-shadow">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-white tracking-light text-3xl font-bold leading-tight"><?php echo e($totalSmtp); ?></p>
                                <p class="text-green-400 text-sm font-medium leading-normal"><?php echo e($activeSmtp); ?> active</p>
                            </div>
                    ...
                    <div class="glass-card rounded-xl p-6 soft-shadow">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-white tracking-light text-3xl font-bold leading-tight"><?php echo e(number_format($usageStats['sent_today'])); ?></p>
                    ...
                    <div class="glass-card rounded-xl p-6 soft-shadow">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-white tracking-light text-3xl font-bold leading-tight"><?php echo e(number_format($usageStats['sent_this_month'])); ?></p>
                    ...
                    <div class="glass-card rounded-xl p-6 soft-shadow">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-white tracking-light text-3xl font-bold leading-tight"><?php echo e($usageStats['success_rate']); ?>%</p>
                ...
                <div class="glass-card rounded-xl overflow-hidden soft-shadow mb-8">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($smtpSettings->count() > 0): ?>
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            ...
                            <tbody>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $smtpSettings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $smtp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="border-b border-white/5 hover:bg-white/5">
                                    <td class="p-4">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($smtp->is_active): ?>
                                    ...
                                    <td class="p-4">
                                        <div class="flex items-center gap-3">
                                            <div class="w-10 h-10 rounded-lg <?php echo e($smtp->is_active ? 'bg-green-500/20' : 'bg-red-500/20'); ?> flex items-center justify-center">
                                                <span class="material-symbols-outlined <?php echo e($smtp->is_active ? 'text-green-500' : 'text-red-500'); ?>">dns</span>
                                            </div>
                                            <div>
                                                <p class="text-white font-medium"><?php echo e($smtp->name); ?></p>
                                                <p class="text-white/60 text-sm"><?php echo e($smtp->host); ?>:<?php echo e($smtp->port); ?></p>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="p-4">
                                        <p class="text-white font-medium"><?php echo e($smtp->host); ?></p>
                                        <p class="text-white/60 text-sm">Port: <?php echo e($smtp->port); ?> (<?php echo e(strtoupper($smtp->encryption)); ?>)</p>
                                    </td>
                                    <td class="p-4">
                                        <p class="text-white font-medium"><?php echo e($smtp->from_address); ?></p>
                                        <p class="text-white/60 text-sm"><?php echo e($smtp->from_name); ?></p>
                                    </td>
                                    <td class="p-4">
                                        <div class="flex flex-col">
                                            <p class="text-white font-medium"><?php echo e($smtp->sent_today); ?>/<?php echo e($smtp->daily_limit); ?></p>
                                            <div class="w-24 h-2 bg-gray-700 rounded-full overflow-hidden mt-1">
                                                ...
                                                ?>
                                                <div class="h-full <?php echo e($usagePercentage > 80 ? 'bg-red-500' : ($usagePercentage > 50 ? 'bg-yellow-500' : 'bg-green-500')); ?> rounded-full" style="width: <?php echo e(min($usagePercentage, 100)); ?>%"></div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="p-4">
                                        <p class="text-white font-medium"><?php echo e(number_format($smtp->total_sent)); ?></p>
                                        <p class="text-white/60 text-sm">All time</p>
                                    </td>
                                    <td class="p-4">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($smtp->last_used_at): ?>
                                        <p class="text-white/70 text-sm"><?php echo e(\Carbon\Carbon::parse($smtp->last_used_at)->format('M d, Y')); ?></p>
                                        <p class="text-white/50 text-xs"><?php echo e(\Carbon\Carbon::parse($smtp->last_used_at)->format('h:i A')); ?></p>
                                        <?php else: ?>
                                    ...
                                    <td class="p-4">
                                        <div class="flex items-center gap-2">
                                            <button onclick="testSmtp(<?php echo e($smtp->id); ?>)" class="p-2 rounded-lg hover:bg-white/10" title="Test Connection">
                                                <span class="material-symbols-outlined text-blue-500">play_arrow</span>
                                            </button>
                                            <button onclick="toggleSmtpStatus(<?php echo e($smtp->id); ?>, <?php echo e($smtp->is_active ? 'true' : 'false'); ?>)" class="p-2 rounded-lg hover:bg-white/10" title="<?php echo e($smtp->is_active ? 'Deactivate' : 'Activate'); ?>">
                                                <span class="material-symbols-outlined <?php echo e($smtp->is_active ? 'text-yellow-500' : 'text-green-500'); ?>"><?php echo e($smtp->is_active ? 'toggle_off' : 'toggle_on'); ?></span>
                                            </button>
                                            <button onclick="editSmtp(<?php echo e($smtp->id); ?>)" class="p-2 rounded-lg hover:bg-white/10" title="Edit">
                                                <span class="material-symbols-outlined text-emerald-500">edit</span>
                                            </button>
                                            <button onclick="deleteSmtp(<?php echo e($smtp->id); ?>)" class="p-2 rounded-lg hover:bg-white/10" title="Delete">
...
<?php /**PATH /mnt/c/Users/DELL/InfiMal/InfiMal-main/resources/views/smtp/index.blade.php ENDPATH**/ ?>