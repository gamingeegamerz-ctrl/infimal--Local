        ...
        <aside class="w-64 bg-white dark:bg-slate-800 border-r border-gray-200 dark:border-slate-700 flex-shrink-0">
            <div class="flex flex-col h-full p-4">
                ...
                <nav class="flex flex-col gap-1 flex-1">
                    ...
                    <a class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-600 dark:text-slate-300 hover:text-gray-900 dark:hover:text-white font-medium text-sm" href="<?php echo e(url('/campaigns')); ?>">
                        <span class="material-symbols-outlined text-xl">campaign</span>
                        <span>Campaigns</span>
                    </a>
                    <a class="nav-link active flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-700 dark:text-white font-medium text-sm" href="<?php echo e(url('/messages')); ?>">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <button class="p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-800 transition-colors relative" id="notificationBtn">
                                ...
                                <span class="absolute -top-1 -right-1 bg-red-500 text-white text-xs rounded-full w-4 h-4 flex items-center justify-center" id="notificationCount">
                                    <?php echo e($stats['unreadCount'] ?? 0); ?>
            ...
            <div class="p-6 space-y-6">
                            ...
                            <div class="flex items-center gap-6">
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-gray-600 dark:text-slate-300 text-sm font-medium">
                                        Unread Messages: <?php echo e($stats['unreadCount'] ?? 0); ?>
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-gray-600 dark:text-slate-300 text-sm font-medium">
                                        Campaign Alerts: <?php echo e($stats['campaignAlertsCount'] ?? 0); ?>
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-gray-600 dark:text-slate-300 text-sm font-medium">
                                        System Warnings: <?php echo e($stats['systemMessagesCount'] ?? 0); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div class="glass-card rounded-2xl p-6 shadow-lg hover-glow transition-all duration-300">
                        ...
                        <p class="text-4xl font-bold text-gray-900 dark:text-white mb-2"><?php echo e($stats['totalMessages'] ?? 0); ?></p>
                        <p class="text-green-600 dark:text-green-400 text-sm font-medium"><?php echo e($stats['unreadCount'] ?? 0); ?> unread</p>
                    </div>
                    ...
                    <div class="glass-card rounded-2xl p-6 shadow-lg hover-glow transition-all duration-300">
                        ...
                        <p class="text-4xl font-bold text-gray-900 dark:text-white mb-2"><?php echo e($stats['systemMessagesCount'] ?? 0); ?></p>
                        <p class="text-blue-600 dark:text-blue-400 text-sm font-medium"><?php echo e($stats['todayMessagesCount'] ?? 0); ?> today</p>
                    </div>
                    ...
                    <div class="glass-card rounded-2xl p-6 shadow-lg hover-glow transition-all duration-300">
                        ...
                        <p class="text-4xl font-bold text-gray-900 dark:text-white mb-2"><?php echo e($stats['campaignAlertsCount'] ?? 0); ?></p>
                        <p class="text-orange-600 dark:text-orange-400 text-sm font-medium"><?php echo e($stats['highPriorityCount'] ?? 0); ?> important</p>
                    </div>
                    ...
                    <div class="glass-card rounded-2xl p-6 shadow-lg hover-glow transition-all duration-300">
                        ...
                        <p class="text-4xl font-bold text-gray-900 dark:text-white mb-2"><?php echo e($stats['thisMonthCount'] ?? 0); ?></p>
                        <p class="text-green-600 dark:text-green-400 text-sm font-medium">+<?php echo e($stats['growthRate'] ?? 0); ?>% from last month</p>
                    </div>
                </div>
                    ...
                    <div class="lg:col-span-3">
                        <div class="glass-card rounded-2xl p-6 shadow-lg">
                            <div class="flex items-center justify-between mb-6">
                                ...
                                <div class="flex items-center gap-3">
                                    <select id="typeFilter" onchange="filterByType(this.value)" class="bg-white dark:bg-slate-800 border border-gray-300 dark:border-slate-700 rounded-lg px-3 py-2 text-gray-700 dark:text-slate-300 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                        ...
                                        <option value="campaign" <?php echo e(request('type') == 'campaign' ? 'selected' : ''); ?>>Campaign</option>
                                        <option value="billing" <?php echo e(request('type') == 'billing' ? 'selected' : ''); ?>>Billing</option>
                            ...
                            <div class="overflow-x-auto">
                                <table class="w-full min-w-full">
                                    ...
                                    <tbody id="messagesTableBody">
                                        ...
                                        <tr class="border-b border-gray-100 dark:border-slate-800 last:border-0 hover:bg-gray-50 dark:hover:bg-slate-800/50 transition-colors <?php echo e($message->status === 'unread' ? 'bg-blue-50 dark:bg-blue-900/10' : ''); ?>" id="message-<?php echo e($message->id); ?>">
                                            <td class="py-4 pl-4">
                                                <div class="flex items-center gap-3">
                                                    <div class="p-2 rounded-lg bg-blue-100 dark:bg-blue-900/50">
                                                        ...
                                                        <span class="material-symbols-outlined text-blue-600 dark:text-blue-400 text-sm">
                                                            <?php echo e($icons[$message->type] ?? 'mail'); ?>

                                                        </span>
                                                    </div>
                                                    <div>
                                                        <p class="text-gray-900 dark:text-white font-medium"><?php echo e($message->subject); ?></p>
                                                        <p class="text-gray-600 dark:text-slate-400 text-sm"><?php echo e(Str::limit($message->content, 70)); ?></p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="py-4">
                                                <span class="message-type type-<?php echo e($message->type); ?>">
                                            ...
                                            <td class="py-4">
                                                <div class="flex items-center gap-2">
                                                    <span class="material-symbols-outlined text-sm priority-<?php echo e($message->priority); ?>">
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($message->priority === 'high'): ?>
                                                        warning
                                                        <?php elseif($message->priority === 'medium'): ?>
                                                        info
                                                        <?php else: ?>
                                                        check_circle
                                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                    </span>
                                                    <span class="text-gray-900 dark:text-white text-sm capitalize"><?php echo e($message->priority); ?></span>
                                                </div>
                                            </td>
                                            <td class="py-4">
                                                <span class="message-status status-<?php echo e($message->status); ?>">
                                            ...
                                            <td class="py-4 pr-4">
                                                <div class="flex items-center gap-2">
                                                    <button onclick="viewMessage(<?php echo e($message->id); ?>)" class="p-1.5 rounded-lg bg-blue-100 dark:bg-blue-900/50 text-blue-600 dark:text-blue-400 hover:bg-blue-200 dark:hover:bg-blue-800 transition-colors" title="View">
                                                        <span class="material-symbols-outlined text-sm">visibility</span>
                                                    </button>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($message->status === 'unread'): ?>
                                                    <button onclick="markAsRead(<?php echo e($message->id); ?>)" class="p-1.5 rounded-lg bg-green-100 dark:bg-green-900/50 text-green-600 dark:text-green-400 hover:bg-green-200 dark:hover:bg-green-800 transition-colors" title="Mark as Read">
                                                        <span class="material-symbols-outlined text-sm">done</span>
                                                    </button>
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                    <button onclick="deleteMessage(<?php echo e($message->id); ?>)" class="p-1.5 rounded-lg bg-red-100 dark:bg-red-900/50 text-red-600 dark:text-red-400 hover:bg-red-200 dark:hover:bg-red-800 transition-colors" title="Delete">
                            ...
                            <div class="flex items-center justify-between pt-6 mt-6 border-t border-gray-200 dark:border-slate-700">
                                ...
                                <div class="flex items-center gap-2">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($messages->onFirstPage()): ?>
                                    ...
                                    <?php else: ?>
                                    <a href="<?php echo e($messages->previousPageUrl()); ?>&type=<?php echo e(request('type', 'all')); ?>&status=<?php echo e(request('status', 'all')); ?>" class="px-3 py-1 text-sm rounded-lg bg-gray-100 dark:bg-slate-800 text-gray-600 dark:text-slate-400 hover:bg-gray-200 dark:hover:bg-slate-700 transition-colors">
                                        Previous
                                    </a>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = range(1, $messages->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($page == $messages->currentPage()): ?>
                                        <span class="px-3 py-1 text-sm rounded-lg bg-blue-100 dark:bg-blue-900/50 text-blue-600 dark:text-blue-400">
                                            <?php echo e($page); ?>

                                        </span>
                                        <?php else: ?>
                                        <a href="<?php echo e($messages->url($page)); ?>&type=<?php echo e(request('type', 'all')); ?>&status=<?php echo e(request('status', 'all')); ?>" class="px-3 py-1 text-sm rounded-lg bg-gray-100 dark:bg-slate-800 text-gray-600 dark:text-slate-400 hover:bg-gray-200 dark:hover:bg-slate-700 transition-colors">
                                            <?php echo e($page); ?>
                                    ...
                                    <a href="<?php echo e($messages->nextPageUrl()); ?>&type=<?php echo e(request('type', 'all')); ?>&status=<?php echo e(request('status', 'all')); ?>" class="px-3 py-1 text-sm rounded-lg bg-gray-100 dark:bg-slate-800 text-gray-600 dark:text-slate-400 hover:bg-gray-200 dark:hover:bg-slate-700 transition-colors">
                                        Next
                                    </a>
                                    <?php else: ?>
                                    <span class="px-3 py-1 text-sm rounded-lg bg-gray-100 dark:bg-slate-800 text-gray-600 dark:text-slate-400 cursor-not-allowed opacity-50">
                    ...
                    <div class="lg:col-span-1 flex flex-col gap-6">
                        ...
                        <div class="glass-card rounded-2xl p-6 shadow-lg">
                            ...
                            <div class="space-y-4">
                                <div class="flex items-center justify-between">
                                    ...
                                    <span class="text-gray-600 dark:text-slate-400 text-sm font-medium"><?php echo e($stats['campaignAlertsCount'] ?? 0); ?></span>
                                </div>
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-gray-600 dark:text-slate-400 text-sm font-medium"><?php echo e($stats['systemMessagesCount'] ?? 0); ?></span>
                                </div>
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-gray-600 dark:text-slate-400 text-sm font-medium"><?php echo e($stats['billingMessagesCount'] ?? 0); ?></span>
                                </div>
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-gray-600 dark:text-slate-400 text-sm font-medium"><?php echo e($stats['supportMessagesCount'] ?? 0); ?></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="glass-card rounded-2xl p-6 shadow-lg">
                            ...
                            <div class="space-y-3">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($recentMessages) > 0): ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $recentMessages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-center justify-between p-2 rounded-lg bg-gray-50 dark:bg-slate-800/50 hover:bg-gray-100 dark:hover:bg-slate-800 transition-colors cursor-pointer" onclick="viewMessage(<?php echo e($message->id); ?>)">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <div>
                                                <span class="text-gray-900 dark:text-white text-sm truncate block max-w-[120px]"><?php echo e(Str::limit($message->subject, 20)); ?></span>
                                                <span class="message-status status-<?php echo e($message->status); ?> text-xs mt-1">
                                                    <?php echo e(ucfirst($message->status)); ?>
...
</html><?php /**PATH /mnt/c/Users/DELL/InfiMal/InfiMal-main/resources/views/messages/index.blade.php ENDPATH**/ ?>