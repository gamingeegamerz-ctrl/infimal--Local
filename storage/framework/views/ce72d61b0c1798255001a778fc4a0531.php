...
<body class="bg-white dark:bg-slate-900 text-gray-900 dark:text-slate-100 transition-colors duration-300">
        ...
        <aside class="w-64 bg-white dark:bg-slate-800 border-r border-gray-200 dark:border-slate-700 flex-shrink-0">
            <div class="flex flex-col h-full p-4">
                ...
                <nav class="flex flex-col gap-1 flex-1">
                    ...
                    <a class="nav-link active flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-700 dark:text-white font-medium text-sm" href="<?php echo e(url('/subscribers')); ?>">
            ...
            <div class="p-6 space-y-6">
                            ...
                            <div class="flex items-center gap-6">
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-gray-600 dark:text-slate-300 text-sm font-medium">
                                        Total Subscribers: <?php echo e($totalSubscribers); ?>
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-gray-600 dark:text-slate-300 text-sm font-medium">
                                        30 Day Growth: +<?php echo e($growth30Days); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div class="glass-card rounded-2xl p-6 shadow-lg hover-glow transition-all duration-300">
                        ...
                        <p class="text-4xl font-bold text-gray-900 dark:text-white mb-2"><?php echo e($totalSubscribers); ?></p>
                        <p class="text-green-600 dark:text-green-400 text-sm font-medium">+<?php echo e($growth30Days); ?> this month</p>
                    </div>
                    ...
                    <div class="glass-card rounded-2xl p-6 shadow-lg hover-glow transition-all duration-300">
                        ...
                        <p class="text-4xl font-bold text-gray-900 dark:text-white mb-2"><?php echo e($activeSubscribers); ?></p>
                        <p class="text-green-600 dark:text-green-400 text-sm font-medium"><?php echo e($totalSubscribers > 0 ? number_format($activeSubscribers/$totalSubscribers*100, 1) : 0); ?>% of total</p>
                    </div>
                    ...
                    <div class="glass-card rounded-2xl p-6 shadow-lg hover-glow transition-all duration-300">
                        ...
                        <p class="text-4xl font-bold text-gray-900 dark:text-white mb-2"><?php echo e($unsubscribedSubscribers); ?></p>
                        <p class="text-green-600 dark:text-green-400 text-sm font-medium"><?php echo e($totalSubscribers > 0 ? number_format($unsubscribedSubscribers/$totalSubscribers*100, 1) : 0); ?>% of total</p>
                    </div>
                    ...
                    <div class="glass-card rounded-2xl p-6 shadow-lg hover-glow transition-all duration-300">
                        ...
                        <p class="text-4xl font-bold text-gray-900 dark:text-white mb-2"><?php echo e($bouncedSubscribers); ?></p>
                        <p class="text-green-600 dark:text-green-400 text-sm font-medium"><?php echo e($totalSubscribers > 0 ? number_format($bouncedSubscribers/$totalSubscribers*100, 1) : 0); ?>% of total</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
                    ...
                    <div class="lg:col-span-3">
                        <div class="glass-card rounded-2xl p-6 shadow-lg">
                            <div class="flex items-center justify-between mb-6">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <select id="listFilter" onchange="filterByList(this.value)" class="bg-white dark:bg-slate-800 border border-gray-300 dark:border-slate-700 rounded-lg px-3 py-2 text-gray-700 dark:text-slate-300 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                                        <option value="all" <?php echo e(request('list_id') == 'all' ? 'selected' : ''); ?>>All Lists</option>
                                        ...
                                        <tr class="border-b border-gray-100 dark:border-slate-800 last:border-0 hover:bg-gray-50 dark:hover:bg-slate-800/50 transition-colors">
                                            <td class="py-4">
                                                <div class="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <p class="text-gray-900 dark:text-white font-medium"><?php echo e($subscriber->email); ?></p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="py-4 text-gray-900 dark:text-white"><?php echo e($subscriber->first_name); ?> <?php echo e($subscriber->last_name); ?></td>
                                            <td class="py-4">
                                                <span class="text-xs px-3 py-1 rounded-full font-medium
                                                    <?php if($subscriber->status === 'active'): ?> bg-green-100 dark:bg-green-900/50 text-green-800 dark:text-green-400
                                                    <?php elseif($subscriber->status === 'unsubscribed'): ?> bg-red-100 dark:bg-red-900/50 text-red-800 dark:text-red-400
                                                    <?php else: ?> bg-orange-100 dark:bg-orange-900/50 text-orange-800 dark:text-orange-400
                                                    <?php endif; ?>">
                                                    <?php echo e(ucfirst($subscriber->status)); ?>

                                                </span>
                                            </td>
                                            <td class="py-4 text-gray-600 dark:text-slate-400 text-sm"><?php echo e($subscriber->mailingList->name ?? 'No List'); ?></td>
                                            <td class="py-4 text-gray-600 dark:text-slate-400 text-sm"><?php echo e($subscriber->created_at->format('M d, Y')); ?></td>
                                            <td class="py-4">
                                                <div class="flex items-center gap-2">
                                                    <button onclick="editSubscriber(<?php echo e($subscriber->id); ?>)" class="p-1.5 rounded-lg bg-blue-100 dark:bg-blue-900/50 text-blue-600 dark:text-blue-400 hover:bg-blue-200 dark:hover:bg-blue-800 transition-colors" title="Edit">
                                                        <span class="material-symbols-outlined text-sm">edit</span>
                                                    </button>
                                                    <button onclick="deleteSubscriber(<?php echo e($subscriber->id); ?>)" class="p-1.5 rounded-lg bg-red-100 dark:bg-red-900/50 text-red-600 dark:text-red-400 hover:bg-red-200 dark:hover:bg-red-800 transition-colors" title="Delete">
                            ...
                            <!-- Pagination -->
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($subscribers->hasPages()): ?>
                            <div class="flex items-center justify-between pt-6 mt-6 border-t border-gray-200 dark:border-slate-700">
                                <div class="text-gray-600 dark:text-slate-400 text-sm">
                                    Showing <?php echo e($subscribers->firstItem()); ?> to <?php echo e($subscribers->lastItem()); ?> of <?php echo e($subscribers->total()); ?> subscribers
                                </div>
                                <div class="flex items-center gap-2">
                    ...
                    <div class="lg:col-span-1 flex flex-col gap-6">
                        ...
                        <div class="glass-card rounded-2xl p-6 shadow-lg">
                            ...
                            <div class="space-y-3">
                                ...
                                <a href="<?php echo e(route('subscribers.export')); ?>" class="w-full flex items-center gap-3 p-3 rounded-lg bg-gray-50 dark:bg-slate-800/50 hover:bg-gray-100 dark:hover:bg-slate-800 transition-colors">
                                ...
                                <a href="<?php echo e(url('/lists')); ?>" class="w-full flex items-center gap-3 p-3 rounded-lg bg-gray-50 dark:bg-slate-800/50 hover:bg-gray-100 dark:hover:bg-slate-800 transition-colors">
                        ...
                        <div class="glass-card rounded-2xl p-6 shadow-lg">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <p class="text-gray-900 dark:text-white text-xl font-bold"><?php echo e($avgOpenRate); ?>%</p>
                                </div>
                                <div>
                                    <p class="text-gray-600 dark:text-slate-400 text-sm">Avg. Click Rate</p>
                                    <p class="text-gray-900 dark:text-white text-xl font-bold"><?php echo e($avgClickRate); ?>%</p>
                                </div>
                                <div>
                                    <p class="text-gray-600 dark:text-slate-400 text-sm">Avg. Engagement</p>
                                    <p class="text-gray-900 dark:text-white text-xl font-bold"><?php echo e(number_format(($avgOpenRate + $avgClickRate) / 2, 1)); ?>%</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="glass-card rounded-2xl p-6 shadow-lg">
                            ...
                            <div class="space-y-3 max-h-60 overflow-y-auto">
                                ...
                                <div class="flex items-start gap-3 p-2 rounded-lg bg-gray-50 dark:bg-slate-800/50">
                                    ...
                                    <div class="flex-1">
                                        <p class="text-gray-900 dark:text-white text-sm"><?php echo e($activity['message']); ?></p>
                                        <p class="text-gray-500 dark:text-slate-500 text-xs"><?php echo e($activity['time']); ?></p>
                                    </div>
                                </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
    ...
    document.getElementById('addSubscriberForm').addEventListener('submit', function(e) {
        ...
        const url = editId ? `/subscribers/${editId}` : '<?php echo e(route("subscribers.store")); ?>';
    ...
    document.getElementById('importForm').addEventListener('submit', function(e) {
        ...
        fetch('<?php echo e(route("subscribers.import")); ?>', {
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
                'Accept': 'application/json'
...
</html><?php /**PATH /mnt/c/Users/DELL/InfiMal/InfiMal-main/resources/views/subscribers/index.blade.php ENDPATH**/ ?>