...
<body class="bg-white dark:bg-slate-900 text-gray-900 dark:text-slate-100 transition-colors duration-300">
        ...
        <aside class="w-64 bg-white dark:bg-slate-800 border-r border-gray-200 dark:border-slate-700 flex-shrink-0">
            <div class="flex flex-col h-full p-4">
                ...
                <nav class="flex flex-col gap-1 flex-1">
                    ...
                    <a class="nav-link active flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-700 dark:text-white font-medium text-sm" href="<?php echo e(url('/lists')); ?>">
            ...
            <div class="p-6 space-y-6">
                            ...
                            <div class="flex items-center gap-6">
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-gray-600 dark:text-slate-300 text-sm font-medium">
                                        Total Lists: <?php echo e($totalLists ?? 0); ?>
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-gray-600 dark:text-slate-300 text-sm font-medium">
                                        Total Subscribers: <?php echo e($totalSubscribers ?? 0); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="glass-card rounded-2xl p-6 shadow-lg hover-glow transition-all duration-300">
                        ...
                        <p class="text-4xl font-bold text-gray-900 dark:text-white mb-2"><?php echo e($totalLists ?? 0); ?></p>
                        <p class="text-green-600 dark:text-green-400 text-sm font-medium"><?php echo e($growthRate ?? 0); ?>% growth</p>
                    </div>
                    ...
                    <div class="glass-card rounded-2xl p-6 shadow-lg hover-glow transition-all duration-300">
                        ...
                        <p class="text-4xl font-bold text-gray-900 dark:text-white mb-2"><?php echo e($totalSubscribers ?? 0); ?></p>
                        <p class="text-green-600 dark:text-green-400 text-sm font-medium"><?php echo e($activeSubscribers ?? 0); ?> active</p>
                    </div>
                    ...
                    <div class="glass-card rounded-2xl p-6 shadow-lg hover-glow transition-all duration-300">
                        ...
                        <p class="text-4xl font-bold text-gray-900 dark:text-white mb-2">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($totalLists ?? 0) > 0 && ($totalSubscribers ?? 0) > 0): ?>
                                <?php echo e(number_format(($totalSubscribers ?? 0) / $totalLists)); ?>
                    ...
                    <div class="lg:col-span-3">
                        <div class="glass-card rounded-2xl p-6 shadow-lg">
                            <div class="flex items-center justify-between mb-6">
                                ...
                                <span class="text-gray-600 dark:text-slate-400 text-sm"><?php echo e(($lists->total() ?? 0)); ?> lists found</span>
                            </div>
                            
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lists && $lists->count() > 0): ?>
                                        ...
                                        <tr class="border-b border-gray-100 dark:border-slate-800 last:border-0 hover:bg-gray-50 dark:hover:bg-slate-800/50 transition-colors">
                                            <td class="py-4">
                                                <div class="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <p class="text-gray-900 dark:text-white font-medium"><?php echo e($list->name ?? 'Sample List'); ?></p>
                                                        <p class="text-gray-600 dark:text-slate-400 text-sm"><?php echo e($list->description ?? 'No description'); ?></p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="py-4">
                                                <span class="text-gray-900 dark:text-white font-medium"><?php echo e($list->subscribers_count ?? 0); ?></span>
                                            </td>
                                            <td class="py-4">
                                                <span class="text-green-600 dark:text-green-400"><?php echo e($list->active_subscribers_count ?? 0); ?></span>
                                            </td>
                                            <td class="py-4">
                                                <span class="text-gray-600 dark:text-slate-400 text-sm">
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($list->created_at)): ?>
                                                        <?php echo e($list->created_at->format('Y-m-d')); ?>
                                            ...
                                            <td class="py-4">
                                                <div class="flex items-center gap-2">
                                                    <a href="<?php echo e(url('/lists/' . ($list->id ?? 1))); ?>" class="p-1.5 rounded-lg bg-blue-100 dark:bg-blue-900/50 text-blue-600 dark:text-blue-400 hover:bg-blue-200 dark:hover:bg-blue-800 transition-colors" title="View">
                                                        <span class="material-symbols-outlined text-sm">visibility</span>
                                                    </a>
                                                    <button onclick="editList(<?php echo e($list->id ?? 1); ?>)" class="p-1.5 rounded-lg bg-gray-100 dark:bg-slate-800 text-gray-600 dark:text-slate-400 hover:bg-gray-200 dark:hover:bg-slate-700 transition-colors" title="Edit">
                                                        <span class="material-symbols-outlined text-sm">edit</span>
                                                    </button>
                                                    <button onclick="deleteList(<?php echo e($list->id ?? 1); ?>)" class="p-1.5 rounded-lg bg-red-100 dark:bg-red-900/50 text-red-600 dark:text-red-400 hover:bg-red-200 dark:hover:bg-red-800 transition-colors" title="Delete">
                            ...
                            <!-- Pagination -->
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lists && $lists->hasPages()): ?>
                            <div class="flex items-center justify-between pt-6 mt-6 border-t border-gray-200 dark:border-slate-700">
                                <div class="text-gray-600 dark:text-slate-400 text-sm">
                                    Showing <?php echo e($lists->firstItem()); ?> to <?php echo e($lists->lastItem()); ?> of <?php echo e($lists->total()); ?> lists
                                </div>
                                <div class="flex items-center gap-2">
                    ...
                    <div class="lg:col-span-1 flex flex-col gap-6">
                        ...
                        <div class="glass-card rounded-2xl p-6 shadow-lg">
                            ...
                            <div class="space-y-3">
                                ...
                                <a href="<?php echo e(url('/subscribers')); ?>" class="w-full flex items-center gap-3 p-3 rounded-lg bg-gray-50 dark:bg-slate-800/50 hover:bg-gray-100 dark:hover:bg-slate-800 transition-colors">
                                ...
                                <a href="<?php echo e(url('/dashboard')); ?>" class="w-full flex items-center gap-3 p-3 rounded-lg bg-gray-50 dark:bg-slate-800/50 hover:bg-gray-100 dark:hover:bg-slate-800 transition-colors">
                        ...
                        <div class="glass-card rounded-2xl p-6 shadow-lg">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <p class="text-gray-900 dark:text-white text-xl font-bold"><?php echo e($avgOpenRate ?? 0); ?>%</p>
                                </div>
                                <div>
                                    <p class="text-gray-600 dark:text-slate-400 text-sm">Avg. Click Rate</p>
                                    <p class="text-gray-900 dark:text-white text-xl font-bold"><?php echo e($avgClickRate ?? 0); ?>%</p>
                                </div>
                                <div>
                                    <p class="text-gray-600 dark:text-slate-400 text-sm">Active Rate</p>
                                    <p class="text-gray-900 dark:text-white text-xl font-bold">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($totalSubscribers ?? 0) > 0): ?>
                                            <?php echo e(number_format(($activeSubscribers ?? 0)/$totalSubscribers*100, 1)); ?>%
                                        <?php else: ?>
                                            0%
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </p>
                        ...
                        <div class="glass-card rounded-2xl p-6 shadow-lg">
                            ...
                            <div class="space-y-3">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($recentLists->count() > 0): ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $recentLists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-center justify-between p-2 rounded-lg bg-gray-50 dark:bg-slate-800/50">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <span class="text-gray-900 dark:text-white text-sm truncate"><?php echo e(Str::limit($list->name ?? 'Untitled', 20)); ?></span>
                                        </div>
                                        <span class="text-gray-600 dark:text-slate-400 text-sm font-medium"><?php echo e($list->subscribers_count ?? 0); ?></span>
                                    </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php else: ?>
    ...
    <div id="createListModal" class="modal-backdrop modal-hidden">
        <div class="bg-white dark:bg-slate-800 rounded-2xl p-6 w-full max-w-md shadow-2xl">
            ...
            <form id="listForm" action="<?php echo e(route('lists.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="space-y-4">
                    <div>
...
</html><?php /**PATH /mnt/c/Users/DELL/InfiMal/InfiMal-main/resources/views/lists/index.blade.php ENDPATH**/ ?>