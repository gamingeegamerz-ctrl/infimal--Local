...
<body class="bg-slate-100 dark:bg-slate-900 min-h-screen flex items-center justify-center p-4">
    <div class="bg-white dark:bg-slate-800 w-full max-w-md rounded-xl shadow p-6 space-y-4">
    <div class="w-full max-w-md bg-white dark:bg-slate-800 rounded-xl shadow p-6 space-y-4">
        <form method="POST" action="{{ route('otp.verify.submit') }}" class="space-y-4">
            ...
            <input name="otp" maxlength="6" required class="w-full border rounded-lg px-3 py-2 bg-white dark:bg-slate-900 dark:border-slate-700 dark:text-white" placeholder="123456" />
