...
class User extends Authenticatable
{
    ...
    {
        $hasLicense = $this->activeLicense()->exists()
            || (
                (string) $this->license_status === 'active'
    ...
    {
        // Legacy paid users with no OTP in-flight should not get blocked.
        if (empty($this->otp_code) && is_null($this->otp_expires_at)) {
            return false;
        }
